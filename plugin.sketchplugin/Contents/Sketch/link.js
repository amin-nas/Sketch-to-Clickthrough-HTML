...
exports['default'] = function (context) {
  ...
  var artboards = (0, _common.getArtboards)(context);
  var data = {
    artboards: artboards
  };

  var webUI = new _sketchModuleWebView2['default'](context, 'link.html', {
        ...
        function setLink(data) {
          (0, _common.executeSafely)(context, function () {
            ...
            selection.iterate(function (item) {
              ...
              context.document.showMessage(String(item.name) + ' linked to ' + String(target.label));
            });
